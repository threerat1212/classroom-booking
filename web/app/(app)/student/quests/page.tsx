  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2">
          ...
          <span className="text-sm font-semibold text-amber-200">{(user as any)?.gold_balance ?? 0}</span>
        </div>
      </div>
              ...
              <div className="mt-4 flex items-center justify-between">
                <div className="flex items-center gap-3 text-xs text-slate-400">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold text-amber-200">+{quest.gold_reward}</span>
                  </div>
